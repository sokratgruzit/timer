...
<!--          :autoplay="true"-->
<!--        ></Canvas-video>-->
<!--        <LazyVideo ref="video" muted :sources="[require(`@/assets/img/start.m3u8`),require(`@/assets/img/start.webm`), require(`@/assets/img/start.mp4`)]" :attrs="{controls: false, playsinline: true, loop: true, autoplay: true,muted: true}"/>-->
